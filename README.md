...
This exercise will help me connect previous knowledge with new knowledge as I get a chance to use Webpack with jsbundling-rails gem to make a react-rails application. 
...
- Greetings in json format displayed on reload when you run rails server
...
```
git clone git@github.com:jkanyi-web/hello-rails-react.git
